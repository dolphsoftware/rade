...
public class DashBoardScreen extends Fragment {
    ...
    private DashBoardScreenViewModel mViewModel;

    public static DashBoardScreen newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.dashboard_screen_fragment, container, false);
    }
